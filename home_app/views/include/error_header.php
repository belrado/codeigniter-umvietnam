...
@font-face {
    ...
    font-style: normal;
    font-weight: 500;
    src: url('/assets/font/NotoSansKrM/NotoSansKR-Medium-Hestia.eot'),
    url('/assets/font/NotoSansKrM/NotoSansKR-Medium-Hestia.eot?#iefix') format('embedded-opentype'),
    url('/assets/font/NotoSansKrM/NotoSansKR-Medium-Hestia.woff') format('woff'),
    url('/assets/font/NotoSansKrM/NotoSansKR-Medium-Hestia.otf') format('opentype');
}
@font-face {
    font-family: 'nskr_dr';
    font-style: normal;
    font-weight: 350;
    src: url('/assets/font/NotoSansKrDR/NotoSansKR-DemiLight-Hestia.eot'),
    url('/assets/font/NotoSansKrDR/NotoSansKR-DemiLight-Hestia.eot?#iefix') format('embedded-opentype'),
    url('/assets/font/NotoSansKrDR/NotoSansKR-DemiLight-Hestia.woff') format('woff'),
    url('/assets/font/NotoSansKrDR/NotoSansKR-DemiLight-Hestia.otf') format('opentype');
}
</style>
